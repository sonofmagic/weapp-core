...
export function createWeappWebSocket(connectSocketMethod: WechatMiniprogram.Wx['connectSocket'] = refs.wx.connectSocket) {
  return class WeappWebSocket extends EventTarget<EventSourceEventMap, 'strict'> {
...
export const WeappWebSocket = createWeappWebSocket()
